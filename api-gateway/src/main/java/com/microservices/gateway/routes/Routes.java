...
public class Routes {
    ...
    @Bean
    public RouterFunction<ServerResponse> productServiceRoute(HandlerFunction handlerFunction){
    ...
    @Bean
    public RouterFunction<ServerResponse> orderServiceRoute(HandlerFunction handlerFunction){
    ...
    @Bean
    public RouterFunction<ServerResponse> inventoryServiceRoute(HandlerFunction handlerFunction){
